...
const featuresData: Feature[] = [
  {
    id: 1,
    title: "Rudal Maintenance",
    paragraph:
      "Meliputi maintenance AC, CCTV, server, alat elektrikal, GPS tracker, dan maintenance pengeboran sumur.",
    btn: "",
    btnLink: "",
    icon: (
      <Image
        src="/images/logo/rudal-maintenance-logo.png"
        alt="Rudal Maintenance"
  ...
  {
    id: 2,
    title: "Rudal MainPower",
    btn: "",
    btnLink: "",
    paragraph:
      "Menyediakan serta me-manage tenaga kerja profesional, termasuk alat apapun dan tenaga kerja di bidang apapun sesuai permintaan client.",
    icon: (
      <Image
        src="/images/logo/rudal-mainpower-logo.png"
        alt="Rudal MainPower"
        className="mx-auto max-w-full rounded-t-xl rounded-tr-xl"
        width={845}
        height={116}
  ...
  {
    id: 3,
    title: "Rudal Technology",
    paragraph:
      "Custom Internet of Things (IOT), melakukan Riset dan Development, serta membuat alat, komponen, dan sensor yang dibutuhkan client.",
    btn: "",
    btnLink: "",
    icon: (
      <Image
        src="/images/logo/rudal-technology-logo.png"
        alt="Rudal Technology"
        className="mx-auto max-w-full rounded-t-xl rounded-tr-xl"
        width={845}
        height={116}
      />
  ...
  },
  {
    ...
    title: "Rudal Track",
    paragraph:
      "Menyediakan Alat Tracking, memonitoring kendaraan client, menyediakan program untuk mempermudah client dalam pengiriman barang",
    btn: "",
    btnLink: "",
    icon: (
      <Image
        src="/images/logo/rudal-track-logo.png"
        alt="Rudal Track"
        className="mx-auto max-w-full rounded-t-xl rounded-tr-xl"
        width={845}
        height={116}
  ...
  },
  {
    ...
    title: "Rudal Design",
    paragraph:
      "Membuat design secara profesional sesuai kebutuhan, video editing dan juga membuat video branding.",
    btn: "",
    btnLink: "",
    icon: (
      <Image
        src="/images/logo/rudal-design-logo.png"
        alt="Rudal Design"
        className="mx-auto max-w-full rounded-t-xl rounded-tr-xl"
        width={845}
        height={116}
